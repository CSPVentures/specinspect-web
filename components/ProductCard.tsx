    ...
    <div className="card group p-4 hover:shadow-cardHover">
      <div className="flex items-start justify-between gap-2">
        <Link href={`/products/${product.id}`} className="min-w-0">
          <h3 className="flex items-center gap-1.5 font-semibold text-white group-hover:text-orange">
        ...
        {onRemove && (
          <button
            ...
            className="rounded-lg p-1.5 text-subdued transition-colors hover:bg-orange/10 hover:text-orange"
          >
